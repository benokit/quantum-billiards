...
def make_stadium_quarter(eps):
    ...
    y_axis = cv.curve(geo.line_r, geo.line_n, geo.line_arc, **params_3, virtual=True, symmetry=True)
    params_4 = {"x0" : 0, "y0" : 0, "x1" : 1+eps, "y1": 0 }
    x_axis = cv.curve(geo.line_r, geo.line_n, geo.line_arc, **params_4, virtual=True, symmetry=True)
